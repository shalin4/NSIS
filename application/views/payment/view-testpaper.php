...
<?php $this->load->view('partials/navbar'); ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/vendor/css/view-testpaper.css">
            ...
            <div id="divTable" style="background-color: #fffcc9" class="form-inline">
                <div class="row">
                    ...
                    <div align="center" class="col-sm-12">
                        ...
                        <h2>TEST PAPER MONEY</h2>

                        <table id="tbl2" width="100%" class="table table-striped" border="1">
                            <tbody>
                                <tr>
                                    <td width="20%" style="background-color: #7d3102;color: #ffffff;">TERM 1</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="background-color: #7d3102;color: #ffffff;">TERM 2</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td style="background-color: #7d3102;color: #ffffff;">TERM 3</td>
                                    <td></td>
                                </tr>
                            </tbody>
